...
export default function QuizCreatorWizard() {
        ...
        <div className="sticky top-0 z-40 bg-white border-b border-slate-200 shadow-sm w-full">
            <div className="max-w-7xl mx-auto px-6 lg:px-8 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 w-1/4">
                    ...
                    <h1 className="text-lg font-bold font-sans text-slate-900 truncate" title={quizSettings.title || 'Untitled Quiz'}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full">
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
                <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                    <h2 className="text-xl font-bold font-sans text-slate-900 mb-5">Quiz Details</h2>
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                    <div className="flex justify-between items-center mb-5">
                        <h2 className="text-xl font-bold font-sans text-slate-900">Assign Classes</h2>
            ...
            <div className="lg:col-span-1 flex flex-col gap-6">
                <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                    <h2 className="text-lg font-bold font-sans text-slate-900 mb-5 flex items-center gap-2">
                ...
                <div className="sticky top-24 flex flex-col gap-4">
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                        <div className="bg-slate-900 p-4 text-center">
                            <h3 className="text-white font-bold font-sans text-lg">Quiz Summary</h3>
                        </div>
    ...
    const renderStep3 = () => (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full max-w-5xl mx-auto">
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
                <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <h2 className="text-3xl font-bold font-sans text-slate-900 mb-2">{quizSettings.title || 'Untitled Quiz'}</h2>
            ...
            <div className="lg:col-span-1 flex flex-col gap-6">
                <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                    <h3 className="text-lg font-bold font-sans text-slate-900 mb-4 border-b border-slate-100 pb-3">Pre-Publish Checklist</h3>
                    <div className="flex flex-col gap-3">
                        <div className="flex items-center gap-3">
                    ...
                    <div className="bg-white w-full max-w-3xl h-full rounded-2xl shadow-2xl flex flex-col overflow-hidden relative">
                        <div className="p-6 bg-slate-50 border-b border-slate-200 flex justify-between items-center shrink-0">
                            <div className="flex flex-col">
                                ...
                                <h2 className="text-xl font-bold font-sans text-slate-900 mt-1">{quizSettings.title || 'Untitled Quiz'}</h2>
                            </div>
            ...
            {isPublishOpen && (
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white max-w-md w-full rounded-3xl p-8 flex flex-col items-center text-center shadow-2xl relative">
                        ...
                        <h2 className="text-2xl font-bold font-sans text-slate-900 mb-2">Publish Quiz?</h2>
